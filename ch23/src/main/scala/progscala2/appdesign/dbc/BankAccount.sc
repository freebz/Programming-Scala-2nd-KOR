...
// Initial state: BankAccount(Money(10.0))
// After credit of $5.0: BankAccount(Money(15.0))
// After debit of $8.5: BankAccount(Money(6.5))
// After debit of $10.0: Failure(java.lang.AssertionError:
//   assertion failed: Overdrafts are not permitted, balance = Money(6.5), debit = Money(10.0))
